---
title: Insert
description: "Insert 来自拉丁语 'inserere'，意为 'into' 和 'plant'，有插入, 放入的意思。它可以作为动词 (to put or place something within something else)，也可以作为名词 (a thing that has been inserted or that is intended to be inserted)。"
sidebar:
  hidden: true
