---
title: Availability
description: "Availability 来自于形容词 'available'，其基本意义是'可利用性'，也可以指'有效性'或者'可达性'。它主要用于描述某种资源（如时间、货物、服务等）或者某人是否可以被使用或者接触。例如，当我们说一个人容易与人交往，我们可以把他描述为'readily available for socializing'。"
sidebar:
  hidden: true
