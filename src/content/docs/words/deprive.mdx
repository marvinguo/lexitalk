---
title: Deprive
description: "Deprive是一个动词，意思是剥夺、使失去。这个词通常与 'of' 一起使用，表示从某人或某事物中取走某个重要的东西。例如： 'Lack of vitamin C can deprive the body of its resistance to illness' (维生素 C 的缺乏会剥夺身体对疾病的抵抗力)。"
sidebar:
  hidden: true
