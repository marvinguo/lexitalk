---
title: Mingle
description: "Mingle 是一个动词，主要有两个含义。一是指将事物混合在一起，特别是使不同种类的事物混在一起。如在食品制作中经常会用到此词，比如 'mingle the spices together'（将香料混合在一起）。第二个含义是社交，指在一个人群中交往，如 'mingle with the guests'（和客人交谈）。"
sidebar:
  hidden: true
