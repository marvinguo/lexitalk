---
title: Cite
description: "Cite' 是一个动词，可以作为“引述，引用”来理解，特别用在引用书籍、论文或演讲的语境中。另外，'cite'还有“提出，列举”（特别是为了证明或者说明某事）的意思。再者，“cite'也可以表示“表扬，嘉奖”。比如，某人因为英勇的行为被表扬，那么英文中可以说'He was cited for his brave actions."
sidebar:
  hidden: true
