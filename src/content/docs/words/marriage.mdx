---
title: Marriage
description: "Marriage 是名词，主要含义是“婚姻”，积极的情感色彩，通常用来指代两人通过法定仪式或手续成为夫妻的状态。也可以用来指代类似婚姻的亲密的关系或结合，比如：The business was a marriage of convenience, not a love match. 这个生意是做着方便，而不是情感的结合。"
sidebar:
  hidden: true
