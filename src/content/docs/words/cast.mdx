---
title: Cast
description: "Cast 是一个多义词，在不同的语境中可以有不同的含义。最常见的意思是 '投掷' 或者 '扔'，比如 'cast a stone into the water'（把一块石头扔进水里）。另外，它还可以表示剧组的全体演员，如 'The cast of the movie was excellent'（这部电影的演员阵容极佳）。此外，'cast' 也可以用于表示塑造、铸造或者投射光线，等等。"
sidebar:
  hidden: true
