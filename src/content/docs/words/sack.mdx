---
title: Sack
description: "让我们来仔细看看英文单词 sack'。 'Sack' 既可以是一个名词，也可以是一个动词。作为名词时，它的主要意思是“袋子、口袋、麻袋”，它也可以指“解雇”,例如:“He got the sack because of his poor performance.（因为表现差，他被解雇了。）。作为动词时，它的主要意思是“解雇”、“劫掠”。"
sidebar:
  hidden: true
