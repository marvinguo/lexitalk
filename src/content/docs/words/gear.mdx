---
title: Gear
description: "Gear 在英语中通常有两个主要意思，第一个意思是“齿轮”，通常指的是机械设备中用来传递动力的部分；第二个意思是“装备、器材”，通常是指钓鱼、露营、运动等活动所需要的设备。比如说 fishing gear (钓鱼装备)，camping gear (露营装备)，sports gear (运动装备)。"
sidebar:
  hidden: true
