---
title: Storey
description: "Storey 是美式英语中表示'楼层'的词语。在英式英语中，通常会用'storey'来表示'certain level or floor of a building or construction'. 例如，'The building has five storeys' 就意味着这个建筑物有五层。"
sidebar:
  hidden: true
