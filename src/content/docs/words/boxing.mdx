---
title: Boxing
description: "Boxing 是英语中的一个动名词，主要有两个含义。首先，作为一个动词，'boxing' 表示'把...装箱'，例如 'I am boxing up my old clothes'（我正在把我的旧衣服装箱）。其次，它也是'拳击'的意思，如'Boxing is a tough sport'（拳击是一项艰难的运动）。"
sidebar:
  hidden: true
