---
title: Alloy
description: "Alloy 是一个英文单词，通常作为名词使用，表示合金，例如：steel is an alloy of iron and carbon（钢是铁和碳的合金）；也可以作为动词，意思是掺合，将少量的一种金属混合在另一种金属中, 例如：The iron was alloyed with copper(这个铁和铜掺合了）"
sidebar:
  hidden: true
