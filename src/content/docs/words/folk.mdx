---
title: Folk
description: "Folk 这个词在英语中有两个主要的含义。第一个是用来指代一组人，特别是那些有共同的国籍，语言，或者是文化背景的人们。这可以是一种对一组人的友好，亲切的称呼，如 'the folks back home' （家乡的人们）。第二个是指民间的，传统的，简单的或是朴素的，如 'folk music'（民谣）。"
sidebar:
  hidden: true
