---
title: About
description: "About是一个常用的英语单词，具有多种含义和用法。通常作为介词使用时，它表示关于（示例：'Let's talk about it'打算让我们谈谈它）。作为副词使用时，'about'可以表示几乎（示例：'The job is about done.' 工作差不多完成了）或在附近（示例：'Look about and tell me what you see.' 看看周围，告诉我你看到了什么）。"
sidebar:
  hidden: true
