---
title: Spiral
description: "Spiral 这个词来源于拉丁语 'spira'，意为螺旋或是盘旋。在英文中，'spiral' 可以做名词，也可以做动词使用。作为名词，它指的是一种连续螺旋形或螺线形的曲线，股票市场的急速下跌或是人的情绪控制力迅速减退等也常用此词 figuratively。而作为动词时，'spiral' 描述的是物体以螺旋形运动或者发展的情况。"
sidebar:
  hidden: true
