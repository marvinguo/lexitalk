---
title: Dysfunction
description: "Dysfunction是一个名词，用来描述事物运行不正常、效力下降或失去正常功能的状态，尤其应用于生物和生理系统。例如生理机能失调 (physiological dysfunction)，或是系统失效(system dysfunction)。在心理学上的应用非常广泛，比如描述一个家庭单元或关系中出现问题的 'family dysfunction'。"
sidebar:
  hidden: true
