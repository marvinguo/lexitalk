---
title: Board
description: "Board是一个英语单词，既可以作为名词又可以作为动词，含有不同的含义。作为名词，常见的意义有'板子'，'董事会'等。例如，'a wooden board'（一块木板），'board of directors'（董事会）。作为动词时，'board'的意思是'登上'，如飞机、船、车等，例如，'board the plane'。"
sidebar:
  hidden: true
