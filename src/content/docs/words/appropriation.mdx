---
title: Appropriation
description: "Appropriation 是一个英语名词，来源于动词 'appropriate'，意为'拨款'或'挪用'。它在不同的上下文中具有不同的含义。在法律语境中，Appropriation 可以指政府对经费的拨款或分配。在艺术领域，Appropriation 是指将预先存在的对象或元素合并到新的作品中。"
sidebar:
  hidden: true
