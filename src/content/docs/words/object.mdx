---
title: Object
description: "Object 是一个很常用的英语单词，它的基本含义是在空间上可观察到的事物，或抽象的目标、目的。但在不同的语境中，这个单词可能有所不同的含义。例如，作为名词时，'object'的英文含义为'物体'，'目标'等等；当我们把它放在一句话中作为动词使用时，'object'又表示'反对'的意思。"
sidebar:
  hidden: true
