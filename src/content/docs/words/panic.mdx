---
title: Panic
description: "Panic是一个名词和动词，主要表示“恐慌”的意思。当被用作名词时，它表示对周围情境的过度反应，通常是由恐惧或者紧张引发的。当作为动词时，它意味着在面对恐怖或压力的情况下失控。例如：They panicked when the fire broke out. (当火灾爆发时，他们恐慌了。)"
sidebar:
  hidden: true
