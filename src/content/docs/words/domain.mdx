---
title: Domain
description: "Domain 在英语中有两个主要的含义。首先，它可以指一个特定的活动或知识领域，比如：'He is an expert in the domain of linguistics.'（他是语言学领域的专家）。其次，它也常用在计算机科学中，指的是一个网络地址的标识符，如：“The domain name for Google is [www.google.com](https://www.google.com).”（谷歌的域名是[www.google.com](https://www.google.com)）。"
sidebar:
  hidden: true
