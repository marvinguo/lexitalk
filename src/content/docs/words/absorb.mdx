...
title: absorb
description: >-
  分析词义 英文单词 absorb 是一个动词，主要有三个意思： 1. 吸收（物质、液体、光线、声音等）例如：A sponge absorbs water.
  2. 理解并记住信息，例如：She absorbed the information in silence. 3. 全神贯注，专注于某事，例如：She
  was totally absorbed in her work. 列举例句 1. Plants absorb carbon dioxide and
  give off oxygen. (植物吸收二氧化碳并释放氧气。
sidebar:
  hidden: true
---
