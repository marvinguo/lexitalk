---
title: Stream
description: "Stream有两个主要的含义。第一个含义是流，意指水流、河流等。例如：'A stream of water is flowing in the mountain'（山里有水流流淌）。第二个含义是流动，意指连续不断的事物，如信息，意见等。例如：'A stream of complaints'（一连串的抱怨）。"
sidebar:
  hidden: true
