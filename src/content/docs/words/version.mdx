---
title: Version
description: "Version主要有两个含义，第一是引申为“版本”，通常用于描述软件、作品、计划等的不同阶段或稍有改动的状态。例如：'Windows 10 is the latest version of Microsoft's operating system.'（Windows 10 是微软最新版本的操作系统）"
sidebar:
  hidden: true
