---
title: Correlate
description: "Correlate 这个单词在英文中主要用作动词和名词。用作动词时，它表示'显示出相关性'，或者'相关联'，例如'Higher levels of education correlate with better mental health.' 。作为名词时，它表示'相互关联的一部分'，例如'The two phenomena were found to be correlates.' 在中文里，我们可以将其翻译为“相关联”。"
sidebar:
  hidden: true
