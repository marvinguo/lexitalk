---
title: Pile
description: "Pile 是一个既可以作为名词，也可以作为动词使用的英语单词。作为名词时，它意味着一堆，一叠，或者一大堆。例如：'a pile of clothes' (一堆衣服)。作为动词时，它意味着把东西堆积起来。例如：'She piled the dishes on the counter' (她把盘子堆在柜子上)。"
sidebar:
  hidden: true
