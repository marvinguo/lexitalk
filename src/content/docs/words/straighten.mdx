---
title: Straighten
description: "Straighten是一个动词，意思是使...变直，或使...整齐，平直。可以用于描述理顺物体，如“straighten your tie”表示“把你的领带理直”，也可以用于比喻，例如“straighten out a misunderstanding”中的'straighten out'表示“澄清误会”。"
sidebar:
  hidden: true
