---
title: Flow
description: "英文单词'flow'主要有两个含义，一是作为动词时，指液体、气体或电的流动、流出、流通，例如 'Water flows from the tap.'（水从龙头流出。）。另一个常见的含义是形容过程、活动等连续无阻碍地进行或发展，例如 'The conversation flowed easily.'（对话流畅自然。）。"
sidebar:
  hidden: true
