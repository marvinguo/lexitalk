---
title: Wishful
description: "Wishful 是一个形容词，通常用来描述人的一种渴望事情达到理想的状态（尽管可能并不现实）的心态。“Wishful thinking” 是一个常用短语，指的是人们对事物采取乐观态度，期望最好的结果，忽视了事实和可能的结果。记忆的时候，可以将 'wishful' 与 'wish' 和 'full' 相关联。"
sidebar:
  hidden: true
