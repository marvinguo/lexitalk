---
title: Hydrocarbon
description: '"Hydrocarbon" 是一个科学术语，主要用于化学领域。这个单词来自于两个词，“hydro” 和 “carbon”。它指的是只含有氢元素（Hydrogen）和碳元素（Carbon）的化合物。 **例句分析：** 1. Methane is the simplest hydrocarbon. 甲烷是最简单的烃。 2. Crude oil is a mixture of different hydrocarbons. 原油是各种不同烃的混合物。 3. Hydrocarbons are the main components of natural gas. 烃是天然气的主要组成部分。'
sidebar:
  hidden: true
