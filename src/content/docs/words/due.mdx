---
title: Due
description: "Due 在英语中是一个多功能词，有许多不同的含义。它可以用作形容词，表示应得的，预定的，或者是因为一种因果关系而应发生的。例如，'the respect that is due to him' (他应得的尊重)。它还可以作为副词，表示直接的或正好的字面意思，如 'due north' (正北方)。"
sidebar:
  hidden: true
