---
title: Emphasis
description: "Emphasis这个单词在英语中是个名词，可以翻译为“强调”、“重点”或者“重视”。当我们需要强调某个观点，或者标注出某个事物的重要性时，就可以使用'emphasis'这个单词。例如，我们可以说'There is an emphasis on team work in this project.'，意思是“这个项目有一种团队合作的重视”。"
sidebar:
  hidden: true
