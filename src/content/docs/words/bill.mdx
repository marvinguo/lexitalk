---
title: Bill
description: "Bill 是一个多义词，涵盖多种含义。首先，它可以表示'账单，清单'。例如，在餐厅，在享用完一顿餐点后，你可能会说 'Can I have the bill please?' （我可以看账单吗？）。第二，'Bill'还可以表示'法案'。在议会中，当一个法律提案被提出时，它被称为 'a bill' （一项法案）。"
sidebar:
  hidden: true
