---
title: Attraction
description: "Attraction是一个名词，主要有两种意义：一是'引力'，主要用于描述物理现象，比如地心引力（gravitational attraction），磁力（magnetic attraction）等；二是'吸引力'或'魅力'，可指吸引人的人、事物或地方，如旅游景点（tourist attraction）。"
sidebar:
  hidden: true
