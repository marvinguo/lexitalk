---
title: Pet
description: "Pet通常有两个主要的含义。一是当名词使用时，它表示一种宠物——人类抚养和照顾的，尤其是狗或猫等小动物。例如，'I have a pet cat named Whiskers.'（我有一只叫做 Whiskers 的宠物猫）。二是当动词使用时，它指的是轻轻地、爱抚地触摸某人或宠物，以表示关爱和亲近。例如，'Could I pet your dog?'（我可以抚摸你的狗吗？）。"
sidebar:
  hidden: true
