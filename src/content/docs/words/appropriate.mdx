---
title: Appropriate
description: "Appropriate 这个单词非常地适当，让我们从字义开始。在英语中，'appropriate' 主要有两种用法。首先，它作为形容词时，意思是“适当的，合适的”，比如说 'It's not appropriate to make such a remark.'（做出这样的评论是不合适的）。其次，作为动词时，意为“挪用，占用”，例如 'The government has appropriated funds for the project.'（政府已拨款给项目）。"
sidebar:
  hidden: true
