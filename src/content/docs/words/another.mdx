---
title: Another
description: "Another 是个英文指示代词，表达 'one more' 或 'an additional' 的概念，也就是中文里的'另一个'或'再一个'的意思。同时，它也可以指 'different from the one or ones already mentioned or known'，即“不同于已知的或已提及的”。"
sidebar:
  hidden: true
