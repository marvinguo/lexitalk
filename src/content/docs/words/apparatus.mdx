---
title: Apparatus
description: "Apparatus 是一个英文名词，主要用于指称一套设备或者工具，尤其是复杂或精细的设备，如科学实验中的仪器设备。也可以指称一个系统或机构，特指涉及很多人、规则以及流程的政府机构或者大型组织。例如：breathing apparatus（呼吸器械）；political apparatus（政治机构）。"
sidebar:
  hidden: true
