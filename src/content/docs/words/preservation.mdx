---
title: Preservation
description: "Preservation 是一个英语名词，源自动词 'preserve'，中文意思可以被理解为'保护'，'维持'，或是'保存'。它可以用于许多上下文中，描述保持某些事物，如建筑、物品、尤其是与自然或文化遗产有关的，例如：环境保护(environmental preservation)，历史保护(historic preservation)等。"
sidebar:
  hidden: true
