---
title: Charter
description: "- 'Charter'是一个很有用的英语单词，作为名词，通常表示“宪章”或者“章程”，比如我们经常听到的'the United Nations Charter'（联合国宪章）；或者表示一种租赁，如'charter flight' (包机); 作为动词时，它表示“租赁”或“设立”，比如 'charter a bus' (租赁一辆公共汽车) 或 'charter a new city' (设立新城市)。"
sidebar:
  hidden: true
