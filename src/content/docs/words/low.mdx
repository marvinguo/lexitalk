---
title: Low
description: "low是一个形容词，意思是'不高的'，'低的'。它可以用于描述物理高度，比如“low ceiling”（低的天花板）；或者抽象的概念，如'low temperature'（低温度）。它还可以用于描述声音的响亮程度，如'low voice'（低声）。'low'还可以表达地位低、程度低或者数量少等意思。"
sidebar:
  hidden: true
