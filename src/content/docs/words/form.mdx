---
title: Form
description: "Form是一个多义词，含有多种意义。作为名词，它可以指物体的形状、尺寸或排列方式，例如“the form of a statue”，意思是“雕像的形状”。它也可以指特定的类型或种类，如“a form of government”，意思是“一种政府形式”。此外，它还可以指表格，如“fill in a form”。"
sidebar:
  hidden: true
