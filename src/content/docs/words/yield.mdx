---
title: Yield
description: "英文单词 'yield' 有多种含义和用法。首先，它可以作为动词，意为“产生”, “屈服”或“让路”。例如：农田产生粮食(yield crops)，或者在压力下屈服(yield to pressure)，或者在交通中让路(yield to traffic)。其次，'yield'也可以作为名词使用，意为收益或产量。例如投资收益(investment yield)或产量(crop yield)。"
sidebar:
  hidden: true
