---
title: Liability
description: "Liability是一个名词，有两个主要的含义：责任（引申为法律责任）和负债。首先，'liability'可以指对行为结果的负责，即责任。比如，如果你在公共场所损坏了物品，你就有 liability 来修复或者赔偿。其次，'liability'在财务术语中是债务或负债的意思。比如，一个公司的 liabilities 可能包括贷款、未付的发票和未付款的工资等。"
sidebar:
  hidden: true
