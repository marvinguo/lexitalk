---
title: Trail
description: "Trail是一个双性质的词，既可以作为名词，也可以作为动词。作为名词，'trail'的意思是路，通常用于描述未经铺设的自然或乡村路；此外，'trail'还可以指一串会留痕的事物，如烟，尾巴等。作为动词，它一般被用来表示跟随，尤其在某人或某物之后。万一援引'trail'这个动词词义，往往是为了指察两者之间有着一定距离。"
sidebar:
  hidden: true
