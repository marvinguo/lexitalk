---
title: Surface
description: "- 'Surface'在英语中有两个主要的意思，一作为名词，表示'表面'或者'平面'，这可以是实物的表面，比如地球的表面(earth's surface)；也可以是抽象意义的“表面”，比如问题的表面(the surface of the problem)。当作动词使用时，'surface'意味着'浮出水面'或者'出现，显露'。"
sidebar:
  hidden: true
