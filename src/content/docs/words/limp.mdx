---
title: Limp
description: "Limp 这个单词在英语中主要有两种用途，作为动词或者形容词。当作为动词时，'limp' 指的是缺乏正常步态或行走的难度，通常由于疼痛或者伤害的原因。这种情况下的中文翻译为“跛行”或者“蹒跚”。而作为形容词时，'limp' 描述的是软弱无力，无生气的状态。比如说，一根熟透的香蕉可能就会被形容为 'limp'。那在形容词的场景下，“limp”的中文翻译为“软弱”或“无力”。"
sidebar:
  hidden: true
