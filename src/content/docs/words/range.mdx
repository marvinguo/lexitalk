---
title: Range
description: "Range这个单词在英语中应用十分广泛，有两个主要的语义领域。一方面，'range'可以表示“范围”，“界限”，例如: the price range (价格范围)。另一方面，'range'也可以作为一个动词，表示'变化'，'分布'，例如: the ages range from 5 to 11 (年龄从 5 到 11 岁不等)。"
sidebar:
  hidden: true
