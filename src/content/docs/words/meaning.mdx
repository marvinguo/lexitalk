---
title: Meaning
description: "Meaning有两个主要的含义。第一个是代表或表示某事物的理解或重要性，例如：'The meaning of life'（人生的意义）。第二个是一个词或句子的定义或解释，例如：'What's the meaning of this word?'（这个词的意思是什么？）。在语言学中，'meaning'还可以指语义。"
sidebar:
  hidden: true
