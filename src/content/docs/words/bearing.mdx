---
title: Bearing
description: "Bearing这个单词的含义非常丰富。最基础的意义是'关系'，'意义'，例如在句中'Have something bearing on sth.'中，表示某事与其有关。此外，它还可以表示'方向'，'态度'或'举止'，比如'I hope he's bearing up under the strain.'中，表示的是'承受住压力'的意思。"
sidebar:
  hidden: true
