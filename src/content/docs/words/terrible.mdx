---
title: Terrible
description: "Terrible是一个形容词，主要用来描述一种非常坏的，令人不悦或令人害怕的情况，等同于中文的'可怕的'，'糟糕的'。例如：a terrible storm (糟糕的暴风雨)。该词也可以用来表达一种非常强烈的情感。例如：I have a terrible headache (我头痛得厉害)。"
sidebar:
  hidden: true
