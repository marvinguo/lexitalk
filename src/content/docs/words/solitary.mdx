---
title: Solitary
description: "Solitary是一个形容词，意为“孤独的，独自的，单独的”。例如，我们可以说 'a solitary journey'（独自一人的旅程）、'a solitary house'（孤零零的房子）、'a solitary lifestyle'（孤独的生活方式）。在生物学中，'solitary'也被用来描述那些独自生活，不成群的动物或植物。"
sidebar:
  hidden: true
