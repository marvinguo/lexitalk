---
title: Admit
description: "Admit是一个英语动词，主要有两层含义。首先，它可以指'接受（有某种事实或真实情况）'，例如，'I have to admit that I felt jealous.'（我必须承认我感到嫉妒）。其次，它也可以指'允许进入'，例如，'The ticket admits two people.'（票可以让两个人进入）。"
sidebar:
  hidden: true
