---
title: Fall
description: "Fall 作为动词，主要有三个基本含义：1) 下降，比如 'Leaves fall from trees'（叶子从树上落下）；2) 落下，比如 'I will fall if I don't be careful'（如果我不小心的话我会跌倒）；3) 倒下，如'Empires rise and fall'（帝国兴衰）。"
sidebar:
  hidden: true
