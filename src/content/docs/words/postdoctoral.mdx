---
title: Postdoctoral
description: "Postdoctoral 是一个复合词，由 'post-' 和 'doctoral' 组成。'Post-' 在这里的意思是“之后”，'doctoral' 则是 'doctorate' 的形容词形式，指的是博士学位。所以'postdoctoral' 通常用于描述关于在取得博士学位后的职业生涯，尤其是在学术研究领域中。例如，一个 'postdoctoral fellow' 或 'postdoc' 是指一个在获得博士学位后从事进一步学术研究的人。"
sidebar:
  hidden: true
