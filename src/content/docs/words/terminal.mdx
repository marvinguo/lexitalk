---
title: Terminal
description: "Terminal是一个英文单词，作名词用时，它有多个含义，例如：1. 终端，比如计算机终端；2. (交通工具的)终点站，如机场的航站楼，或者公交，火车的终点站；3. 终端设备，如电视上的信号接收终端。作形容词时，它表示'末端的'，'最终的'，如 terminal stage 意为'末期阶段'。"
sidebar:
  hidden: true
