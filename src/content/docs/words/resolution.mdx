...
title: resolution
description: >-
  分析词义： Resolution 英 [ˌrez.əˈluː.ʃən]，这个词具有多个意义： 1. 解决，决定，决心：如 to make a
  resolution to do something（决定做某事） 2. 决议，决定：如 a resolution was passed by
  parliament （议会通过了一个决议） 3. 解析度：如 high resolution image（高清晰度的图片） 列举例句： 1. As a
  New Year resolution, I promised to quit smoking.（作为新年决心，我承诺要戒烟。
sidebar:
  hidden: true
---
