---
title: Total
description: "Total有两个主要的词义。第一，它是一个形容词，常用来形容完全的、全部的、绝对的。如：The total number of students in this school is 500.（这所学校的学生总数是 500。）第二，它也可作一个动词，意为计算总数，如：We need to total up the cost.（我们需要计算总成本。）"
sidebar:
  hidden: true
