---
title: Astronomical
description: "Astronomical 这个单词源自天文学（astronomy），在英语里它有两个主要的含义。第一，它可以形容与天文学有关的，例如：astronomical phenomena（天文现象）。第二，它可以用来形容异常巨大或者高的，比如：an astronomical price（天文般的价格）。"
sidebar:
  hidden: true
