---
title: Either
description: "Either 是一个用在选择或者可能性中的词，有三种主要含义。第一种是'两者之一'，例如：'You can either stay or go.'（你可以留下来，也可以离开）。第二种是'不论哪种'，例如：'I don't mind. Either way is fine.'（我不介意，哪种方式都行）。第三种则是用在否定句中，表示'也不'，例如：'I don't like either option.'（我两个选项都不喜欢）。"
sidebar:
  hidden: true
