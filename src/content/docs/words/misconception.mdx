---
title: Misconception
description: "Misconception 是一个英语词汇，其字面含义是误解、误会。它是由 'mis-' 和 'conception' 两个部分组成的，其中 'mis-' 是一个前缀，有'错误地、不正确地'的意思，而 'conception' 则表示'构想、理解'。所以，'misconception' 这个单词的含义就是对某样事物的理解出现了错误或者偏差。"
sidebar:
  hidden: true
