---
title: Accommodate
description: "Accommodate是动词，它有几种主要含义：1）提供住宿或空间；2）使适应或协调；3）满足（某人）的需要或愿望。举例来说，如果一个酒店可以 'accommodate' 200 个客人，那就意味着它有足够的房间为 200 个客人提供住宿。同样的，一个灵活的计划或体系可能会被设计成可以 'accommodate' 各种不同的需要或需求。"
sidebar:
  hidden: true
