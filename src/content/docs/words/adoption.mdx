---
title: Adoption
description: "Adoption 是一个名词，主要有两种含义：1. 接受并开始使用 (某种想法、方法等)。例如：Developed countries have led in the adoption of this technology. （发达国家在这项技术的采用上处于领先地位。）2. 收养，法律依据下的接过他人的子女并把他/她当作自己的孩子来抚养。例如：They were considering adoption. （他们正在考虑收养孩子。）"
sidebar:
  hidden: true
