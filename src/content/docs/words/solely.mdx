---
title: Solely
description: "Solely is an adverb that means 'only' or 'not involving anything or anyone else'. It can emphasize that only a particular thing is involved in something."
sidebar:
  hidden: true
