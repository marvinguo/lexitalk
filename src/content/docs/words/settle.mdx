---
title: "settle"
description: "Settle 是一个英语词语，主要有几个意思： 1. 解决，排解（如争端、争论等） 2. 定居，安家 3. 安排，把…放在适当的位置 4. 支付（账单等） 列举例句 例句参考： 1. Let's settle this dispute once and for all. （我们一劳永逸地解决这个争端吧。"
---
