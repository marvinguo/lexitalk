...
description: "Telecommunications 是一个复合词，由 'tele' 和 'communications' 组成。'Tele-'的来源是希腊词'τῆλε'，意为'远'，而'communications'则来自拉丁词'communicare'，意为'分享'。因此，'telecommunications' 的意思是'远距离的通信'。目前，这个单词主要用于描述通过电子系统传输信息的技术和行业。"
sidebar:
  hidden: true
