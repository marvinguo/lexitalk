---
title: Realization
description: "Realization 这个词来源于动词 'realize'。它主要有两个含义：一是实现、达成或完成的过程；二是对某事的认识或理解，即突然明白或理解的瞬间。例如，'the realization of a dream' (实现一个梦想)，和 'the sudden realization that...' (突然明白...)."
sidebar:
  hidden: true
