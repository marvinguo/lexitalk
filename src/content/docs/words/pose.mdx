---
title: Pose
description: "Pose在英语中是一个多义词，可作为动词和名词使用。当作为动词使用时，“pose”有两个主要含义：(1) 表示“提出，提问”，一般用来指在讨论或研究中提出问题或挑战；(2) 表示“摆姿势”，通常指人或模特在照片或画作中摆出特定的姿势。此外，'pose'还有“假装，伪装”的意思。当'pose'作为名词使用时，主要指“姿势”。"
sidebar:
  hidden: true
